...
<div id="error-container">
    <div class="row text-center">
        <div class="col-md-6 col-md-offset-3">
            ...
            <h2 class="text-muted animation-fadeInQuickInv"><em>متاسفیم ولی این صفحه پیدا نشد..</em></h2>
        </div>
        <div class="col-md-4 col-md-offset-4">
            <!-- <form action="page_ready_search_results.html" method="post" class="push">
                <div class="input-group input-group-lg">
                    <input type="text" id="search-term" name="search-term" class="form-control" placeholder="جستجو در سایت..">
                    <div class="input-group-btn">
                        <button type="submit" class="btn btn-effect-ripple btn-primary"><i class="fa fa-search"></i></button>
                    </div>
                </div>
            </form> -->
            <a href="/" class="btn btn-effect-ripple btn-default"><i class="fa fa-arrow-right"></i> برگشت به صفحه اصلی</a>
        </div>
    </div>
</div>
<!-- END Error Container -->
